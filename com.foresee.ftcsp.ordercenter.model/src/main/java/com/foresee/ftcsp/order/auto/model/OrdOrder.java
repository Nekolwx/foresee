...
public class OrdOrder implements Serializable {
    ...
    /**
     * 开票状态0 未开票 1 已开票 2 不需要开票  3 开票中 4 开票失败 5 红冲中 6 已红冲 7 红冲失败
     * 表 : t_ord_order
     * 对应字段 : billing_status
     */
     ...
     *
     * @MBG Generated Fri Dec 15 11:27:54 CST 2017
     */
     ...
     * get method 
     *
     * @return t_ord_order.billing_status：开票状态0 未开票 1 已开票 2 不需要开票  3 开票中 4 开票失败 5 红冲中 6 已红冲 7 红冲失败
     */
     ...
     * set method 
     *
     * @param billingStatus  开票状态0 未开票 1 已开票 2 不需要开票  3 开票中 4 开票失败 5 红冲中 6 已红冲 7 红冲失败
     */
     ...
     * get method 
     *
     * @return t_ord_order.goods_quantity_unit：数量单位(1、次；2、台；3、件；4、套)
     */
     ...
     * set method 
     *
     * @param goodsQuantityUnit  数量单位(1、次；2、台；3、件；4、套)
     */
     ...
     * get method 
     *
     * @return t_ord_order.channel：售卖渠道（0 平台 1 网站 2金财代账 3 微信商城）
     */
     ...
     * set method 
     *
     * @param channel  售卖渠道（0 平台 1 网站 2金财代账 3 微信商城）
     */
     ...
     * get method 
     *
     * @return t_ord_order.opening_mode：1、即时开通;2、人工开通;3、付款开通
     */
     ...
     * set method 
     *
     * @param openingMode  1、即时开通;2、人工开通;3、付款开通
     */
     ...
     * get method 
     *
     * @return t_ord_order.service_mode：服务方式 0 按时间服务 1按次数服务
     */
     ...
     * set method 
     *
     * @param serviceMode  服务方式 0 按时间服务 1按次数服务
     */
     ...
     * get method 
     *
     * @return t_ord_order.service_term_value：服务期限值
     */
     ...
     * get method 
     *
     * @return t_ord_order.service_term_unit：服务期限单位0 天 1 月 2 年
     */
     ...
     * set method 
     *
     * @param serviceTermUnit  服务期限单位0 天 1 月 2 年
     */
     ...
     * get method 
     *
     * @return t_ord_order.is_delivery：是否需要配送0 不需要 1 需要-快递 2 需要-上门自提
     */
     ...
     * set method 
     *
     * @param isDelivery  是否需要配送0 不需要 1 需要-快递 2 需要-上门自提
     */
     ...
     * get method 
     *
     * @return t_ord_order.contact_person：联系人
     */
     ...
     * get method 
     *
     * @return t_ord_order.contact_phone：联系电话
     */
     ...
     * get method 
     *
     * @return t_ord_order.channel_option：渠道方式（0自营、1航信、2自购）
     */
     ...
     * set method 
     *
     * @param channelOption  渠道方式（0自营、1航信、2自购）
     */
     ...
     * get method 
     *
     * @return t_ord_order.is_have_sub_order：是否有子订单（0否，1是）
     */
     ...
     * set method 
     *
     * @param isHaveSubOrder  是否有子订单（0否，1是）
     */
     ...
     * get method 
     *
     * @return t_ord_order.toll_point：收费网点
     */
     ...
     * set method 
     *
     * @param tollPoint  收费网点
     */
    public void setTollPoint(String tollPoint) {
        this.tollPoint = tollPoint == null ? null : tollPoint.trim();
    }

    /**
     * get method 
     *
     * @return t_ord_order.contract_code：合同编码
     */
     ...
     * get method 
     *
     * @return t_ord_order.contract_charging_start_time：计费开始日期
     */
     ...
     * get method 
     *
     * @return t_ord_order.contract_charging_end_time：计费结束日期
     */
     ...
     * get method 
     *
     * @return t_ord_order.goods_code：商品编码
     */
    ...
    public String toString() {
        ...
        sb.append(", tollPoint=").append(tollPoint);
